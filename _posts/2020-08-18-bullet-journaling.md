...
If you, like me, frequent Pinterest and Instagram, you've probably seen Bullet Journals. For the last several years, I've come across dozens of overly-styled view-from-above photos of beautifully illustrated pages with elaborate handwriting (in a "bridesmaid font" style, of course), artist-grade pens and markers or highlighters placed _slightly_ off-parallel to give that "I just happened to take a picture of my desk in it's natural state" vibe. Based on these images, I thought Bullet Journals were something I would I never have the time or artistic ability to ever use. However, I've now learned that this perception I had is actually pretty wrong. 

While aspirational "BuJo" culture certainly exists, a Bullet Journal _isn't_ a perfectly-designed show-off piece for influencers and lifestyle bloggers; it _is_ a proven organizational system based on a simple note-taking practice which anyone can use to help tame the chaos of their life and work. I've been using a Bullet Journal for a little over a month now, and it's helped me to get on top of my endless to-do list and ensure that I'm doing the things I need to do, and, most importantly, I feel like I'm more in control of the chaos. I love my Bullet Journal, and you might too!

I started to re-discover Bullet Jounals when searching for an organizational method recommended for people with ADHD that is _paper-based_. I've tried all the hot todo apps - Evernote, Clear, Todoist, Notion, Trello - but I never managed to use any of them for more than a day or two. For a long time, I saw this inability to "just get organized" as a failure, but looking back, digital methods never worked because I have been and always will be an inveterate note-taker (and, of course, the whole ADHD thing). I have notebooks going back many years that are chock full of notes from meetings, conferences, brainstorming sessions, etc. So, when I started looking for help to tame my seemingly neverending to-do list, I knew I had to find something that worked with my nature, not against it.

Enter the Bullet Journal! Multiple articles recommend the system for people with ADHD. Ryder Carrol [has even written about how he created the Bullet Journal system](https://humanparts.medium.com/inside-adhd-55b9618cd708) largely to help him manage his ADHD brain - he eloquently calls it "catching the rain". The core system is done entirely with a notebook and pen or pencil (if you are more of a typed notes person, you can totally do bullet journaling digitally!). I found bulletjournal.com, which focuses on the "traditional" or core system, and has an excellent series of super easy to understand videos and tutorials, but in software terms, it felt more like an API reference when I was looking for a cookbook. to be fair, I've been told that the _book_ has more detail on the process, and I'm waiting for my local bookshop to special order it. I did more googling to figure out how to get started, how do people use it in real life, etc. but it was hard to find something that felt like it was speaking to me in my situation - I'm not planning a month of blog posts and their social campaigns (although I probably should), I'm wrangling work and kids. So, hopefully this blog post provides those things I was looking for. 

The beauty of the bullet journal system is that it's completely flexible - giving you free rein to use it your way, but it's not totally structureless. You start with a blank notebook and add your own, minimal organization. Unlike with a traditional paper planner, there is no guilt that you missed a day, or that you didn't fill out the calendar for that month, or that the kinds of notes you want to take don't fit into the structure of the page in front of you. But, there's _just enough_ structure so that you don't feel like you are endlessly circling without moving forward in tackling the items on your to-do list. And, the best part is that you can start on any day you like, no worries about buying a planner for the year and having to leave multiple days or months blank (yes the very thought of doing this causes me high anxiety!).
